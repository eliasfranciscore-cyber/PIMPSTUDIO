...
## Corpus Check
- 127 files · ~1,738,732 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 954 nodes · 1593 edges · 95 communities (51 shown, 44 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 41 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `de60d5cc`
...
Cohesion: 0.06
Nodes (31): BookingsInbox(), FILTER_MAP, FILTERS, initialsOf(), NEXT_STATUS, ResCard(), ResModal(), resolveBarber() (+23 more)
...
## Knowledge Gaps
- **270 isolated node(s):** `STATUS_LABEL`, `STATUS_OPTIONS`, `FILTERS`, `FILTER_MAP`, `STATUS_TO_FILTER` (+265 more)
...
- **What connects `STATUS_LABEL`, `STATUS_OPTIONS`, `FILTERS` to the rest of the system?**
