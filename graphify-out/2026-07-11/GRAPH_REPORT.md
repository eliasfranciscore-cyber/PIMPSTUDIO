...
## Corpus Check
- 108 files · ~412,161 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 895 nodes · 1688 edges · 83 communities (44 shown, 39 thin omitted)
...
5. `requireInternal()` - 20 edges
6. `BookingStatus` - 19 edges
7. `CLP()` - 18 edges
8. `Dashboard()` - 17 edges
...
Cohesion: 0.14
Nodes (27): isAdminUser(), AGENDA_SLOTS, buildWeek(), CFG_SECTIONS, ConfigPanel(), Dashboard(), DAY_LABELS, getSvcIcon() (+19 more)
...
Cohesion: 0.17
Nodes (17): react, ClientModal(), Bars(), CAT_COLORS, DashboardResumen(), getSvcIconByName(), localDateKey(), OccupancyRing() (+9 more)
...
Cohesion: 0.13
Nodes (12): BookingsInbox(), FILTER_MAP, FILTERS, initialsOf(), ResCard(), ResModal(), resolveBarber(), STATUS_LABEL (+4 more)
...
## Knowledge Gaps
- **247 isolated node(s):** `dev-wrapper.sh script`, `NVM_DIR`, `ALL_SLOTS`, `STATIC_BARBERS`, `DEMO_BOOKINGS` (+242 more)
