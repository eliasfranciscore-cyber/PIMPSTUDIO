...
## Corpus Check
- 131 files · ~1,979,316 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1130 nodes · 1941 edges · 97 communities (66 shown, 31 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 54 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fca8615a`
...
Cohesion: 0.11
Nodes (18): CaseIterable, DashboardFocus, dia, semana, workshop, Date, String, AppTab (+10 more)
...
Cohesion: 0.18
Nodes (11): BookingStatus, cancelada, completada, confirmada, enCurso, pendiente, SlotState, blocked (+3 more)
...
Cohesion: 0.15
Nodes (15): DashboardModel, Booking, Double, Int, URL, DemoData, Booking, BookingDraftSheet (+7 more)
...
Cohesion: 0.16
Nodes (16): BookingSheet, encoded(), EnrollmentSheet, PaymentSheet, reminderDate(), scheduleReminder(), StatusChoiceButton, Booking (+8 more)
