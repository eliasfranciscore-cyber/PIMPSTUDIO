...
## Summary
- 469 nodes · 714 edges · 38 communities (25 shown, 13 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.86)
...
10. `estilo-teaser.jpg (style module teaser image)` - 8 edges
...
Cohesion: 0.05
Nodes (33): scrollToId(), useBrunettiFx(), ICONS, ModuleFooter(), NAV, SiteNav(), Cursos(), INCLUDES (+25 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (37): Bars(), CAT_COLORS, DashboardResumen(), STATUS_DOT, TopSvc(), GlareCard(), Icon(), PATHS (+29 more)
...
Cohesion: 0.08
Nodes (24): CHANGELOG de implementación, Brunetti single-barber rebrand, Hero gooey-effect removal, Light-mode polish pass, autoTheme(), iOS dynamic theme-color sync, FloatingThemeToggle(), Santiago-hour automatic theme (+16 more)
...
- **Why does `Icon()` connect `Community 3` to `Community 0`, `Community 1`, `Community 4`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `useTheme()` connect `Community 5` to `Community 9`, `Community 4`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `ThemeProvider()` connect `Community 5` to `Community 4`?**
