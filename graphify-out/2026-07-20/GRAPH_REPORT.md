...
8. `Design Engineering` - 16 edges
9. `Animation Standards Reference` - 16 edges
10. `Barber` - 15 edges
...
Cohesion: 0.08
Nodes (19): Data, Foundation, DashboardFocus, dia, semana, workshop, Date, String (+11 more)
...
Cohesion: 0.07
Nodes (27): dependencies, framer-motion, @neondatabase/serverless, react, react-dom, react-router-dom, @vercel/analytics, @vercel/blob (+19 more)
...
Cohesion: 0.14
Nodes (15): EditableText(), ICONS, ModuleFooter(), FACE_SHAPES, GALLERY, GALLERY_CATS, HERO_PHOTOS, u() (+7 more)
...
### Community 17 - "ui.jsx"
Cohesion: 0.13
Nodes (10): Brandmark(), Emblem(), Icon(), ICONS, MobileScreen(), Reveal(), useInView(), fmtPhone() (+2 more)
...
Cohesion: 0.12
Nodes (13): ALL_SLOTS, buildWeek(), CAT_LABEL, CLIENT_APPTS, CLIENTS, DAYS_ES, EXPENSES, isoDate() (+5 more)
...
Cohesion: 0.07
Nodes (27): BookingsInbox(), FILTER_MAP, FILTERS, initialsOf(), NEXT_STATUS, ResCard(), ResModal(), resolveBarber() (+19 more)
...
Cohesion: 0.21
Nodes (9): EditingContext, OverridesContext, Editable(), styleFromOverride(), DevEditProvider(), loadFileOverrides(), MODULES, OverridesProvider() (+1 more)
...
Cohesion: 0.11
Nodes (18): scrollToId(), useBrunettiFx(), EditContext, ContainerScroll(), Lamp(), Sparkles(), CARD_IMAGES, CARDS (+10 more)
...
Cohesion: 0.15
Nodes (11): DashboardModel, Booking, Double, Int, URL, BookingDraftSheet, ClientSheet, ExpenseSheet (+3 more)
...
Cohesion: 0.29
Nodes (7): AppTab, clientes, finanzas, hoy, mas, reservas, Sendable

### Community 94 - "ModuleFooter.jsx"
Cohesion: 0.33
Nodes (6): Error, APIError, badStatus, invalidURL, missingData, LocalizedError

## Knowledge Gaps
- **392 isolated node(s):** `DEMO_BOOKINGS`, `STATUS_LABEL`, `STATUS_OPTIONS`, `FILTERS`, `FILTER_MAP` (+387 more)
...
- **Why does `DashboardModel` connect `FintocCheckout.jsx` to `iOS Data Models`, `iOS API Client`, `iOS Detail Sheets & Module Views`, `DetailSheets.swift`, `iOS Agenda & Reservations Views`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `SessionStore` connect `iOS Data Models` to `iOS Detail Sheets & Module Views`, `iOS Agenda & Reservations Views`, `iOS API Client`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `SwiftUI` connect `iOS Agenda & Reservations Views` to `iOS Data Models`, `iOS API Client`, `DetailSheets.swift`, `iOS Design System`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **What connects `DEMO_BOOKINGS`, `STATUS_LABEL`, `STATUS_OPTIONS` to the rest of the system?**
