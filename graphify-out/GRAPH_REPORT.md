...
## Summary
- 405 nodes · 631 edges · 32 communities (20 shown, 12 thin omitted)
...
Cohesion: 0.06
Nodes (41): ClientModal(), Bars(), CAT_COLORS, DashboardResumen(), STATUS_DOT, TopSvc(), GlareCard(), Icon() (+33 more)
...
Cohesion: 0.09
Nodes (24): ThemeCtx, ThemeProvider(), ThemeToggle(), useTheme(), AGENDA_SLOTS, buildWeek(), CFG_SECTIONS, ConfigPanel() (+16 more)
...
### Community 15 - "Proposal Generation Script"
Cohesion: 0.40
...
## Knowledge Gaps
- **115 isolated node(s):** `BARBER_PROFILES`, `ALL_SLOTS`, `STATIC_BARBERS`, `DEMO_BOOKINGS`, `DEMO_CLIENTS` (+110 more)
...
- **Why does `Icon()` connect `Barber Profile & Inbox` to `Auth & API Layer`, `Workshop Data & Content`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `CLP()` connect `Auth & API Layer` to `Workshop Data & Content`, `Client Registration API`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `barberById()` connect `Auth & API Layer` to `Workshop Data & Content`, `Client Registration API`?**
